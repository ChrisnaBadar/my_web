...
import 'package:my_web/pages/widgets/buttons/social_button.dart';
import 'package:my_web/pages/widgets/circular_container.dart';
import 'package:my_web/pages/widgets/nimbus_card.dart';
    ...
    return Stack(
      children: [
        Positioned(
          ...
          child: Image.asset(
            ImagePath.SITE_PLAN,
            height: widget.globeSize! * 7,
            width: widget.globeSize! * 7,
          ),
        ),
        Image.asset(
